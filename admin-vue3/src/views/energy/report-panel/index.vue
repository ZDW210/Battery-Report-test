...
<head>
  ...
  <style>
    ...
    * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    .export-status { display: flex; align-items: center; color: #0f766e; font-size: 12px; font-weight: 700; }
...
<body>
  ...
  <div class="bill-layout">
    <section class="bill-box">
      <div class="bill-box-title"><span>账单概况</span><small>单位：kWh、元</small></div>
...
.energy-report-panel {
  ...
  .bill-overview__row {
    display: grid;
    grid-template-columns: minmax(170px, 1.3fr) minmax(110px, .7fr) minmax(100px, .55fr);
    align-items: center;
    column-gap: 12px;
    min-height: 34px;
    padding: 0 12px;
