...
export enum DICT_TYPE {
  ...
  // ========== ENERGY - 移动储能模块 ==========
  ENERGY_DEVICE_STATUS = 'energy_device_status', // 移动储能设备状态
  ENERGY_DEVICE_TYPE = 'energy_device_type', // 移动储能设备类型
  ENERGY_RUN_MODE = 'energy_run_mode', // 移动储能运行模式
  ENERGY_ALARM_LEVEL = 'energy_alarm_level', // 移动储能告警等级
  ENERGY_ALARM_STATUS = 'energy_alarm_status', // 移动储能告警状态
  ENERGY_SESSION_TYPE = 'energy_session_type', // 移动储能会话类型
  ENERGY_SESSION_STATUS = 'energy_session_status', // 移动储能会话状态
  ENERGY_DISPATCH_STATUS = 'energy_dispatch_status', // 移动储能调度状态
